...
const Features = () => {
  return (
    <section className="py-[3rem] md:bg-[#F1F6FA] bg-[#ffffff] md:px-[5rem] px-[4.5rem]">
      <div className="w-11/12 container">
        <div className="text-center">
          <h1 className="md:text-[50px] text-[29px] font-semibold md:font-medium pb-[2rem]">
            Special Features
          </h1>
        </div>
        ...
        <div className="md:flex items-center justify-center grid w-full md:gap-[9rem] gap-[2rem]">
          <div className="flex flex-col items-center gap-[1rem] text-center">
            ...
            <h1 className="font-medium md:text-[23.59px] text-[16px]">
              Customizable Meal Plan
            </h1>
            <p className="md:text-[16px] text-[14px]">
              &quot;Personalize your meals to suit your taste . Match items to
          ...
          <div className="flex flex-col items-center gap-[1rem] text-center">
            ...
            <p className="md:text-[16px] text-[14px]">
              &quot;Track your order item from kitchen to doorstep. Know exactly
              when your meal will arrive.&quot;
            </p>
          </div>
          <div className="flex flex-col items-center  gap-[1rem] text-center">
            <div>
            ...
            <p className="md:text-[16px] text-[14px]">
              &quot;Ordering for a crowd? Easily split and customize group
              orders for everyone.&quot;
            </p>
          </div>
        </div>
