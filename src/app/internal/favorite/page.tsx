...
const FavoritesPage = () => {
  ...
  const handleRemoveFavoriteFood = (id: string): void => {
    const updatedFavorites = favoriteFood.filter((fav: any) => fav.id !== id);
  ...
  const handleRemoveFavoriteRestaurant = (id: string): void => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
        {favoriteRestaurant.map((favorite: any) => (
          <div
            key={favorite.id}
