...
const Slider = () => {
  return (
    <div className="w-full text-center bg-[#073126] text-white  py-[2rem]">
      <div className="w-11/12 container ">
        ...
        <div
          className={`flex gap-[5rem] justify-center items-center ${styles.logos}`}
        >
          {/* First logo slide */}
          <div
            className={`${styles.logosSlide} flex gap-[5rem] flex-row items-center`}
          >
