...
const CartPreview = () => {
  return (
    <div className='bg-white border rounded-l-3xl py-4 px-7 h-[30rem] lg:flex hidden flex-col fixed right-0 top-20 lg:w-[278px] xl:w-[280px]'>
      <div>
        <h1 className='font-semibold'>My Cart Preview</h1>
      </div>
      <div className='mt-10 flex flex-col justify-center items-center'>
        <Image src={cart} alt=''  className='rounded-full border border-[#D9D9D938] bg-[#D9D9D938] py-[2.5rem] px-5'/>
